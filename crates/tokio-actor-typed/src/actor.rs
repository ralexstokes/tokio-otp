...
///
/// This trait is deliberately not implemented for plain closures: an actor
/// is a named type that implements `Actor`, which keeps the message type
/// visible at the definition site and the actor's state explicit.
